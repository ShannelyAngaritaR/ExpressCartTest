...
public class CartPage {
    ...
    private By notifyError500 = By.xpath("//*[@id=\"container\"]/div/div/div/div/h1");
    ...
    public boolean controlError500(){
        boolean result = false;
        try {
            String notify = wait.until(ExpectedConditions.visibilityOfElementLocated(notifyError500)).getText();
            if (notify.equals("Oops! Algo salió mal en el servidor. Por favor, inténtalo de nuevo más tarde.")) {
                result = true;
            }
            Thread.sleep(2000);
        } catch (Exception e) {
